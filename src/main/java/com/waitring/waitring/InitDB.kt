...
//            em.persist(menu15)
             ...
             * 가게_키워드 테스트 데이터
             */
//            val storeKeyword1 = StoreKeyword.builder().store(store1).keyword(keyword1).build()
//            em.persist(storeKeyword1)
//            val storeKeyword2 = StoreKeyword.builder().store(store1).keyword(keyword2).build()
//            em.persist(storeKeyword2)
//            val storeKeyword3 = StoreKeyword.builder().store(store1).keyword(keyword3).build()
//            em.persist(storeKeyword3)
//            val storeKeyword4 = StoreKeyword.builder().store(store2).keyword(keyword4).build()
//            em.persist(storeKeyword4)
//            val storeKeyword5 = StoreKeyword.builder().store(store2).keyword(keyword5).build()
//            em.persist(storeKeyword5)
//            val storeKeyword6 = StoreKeyword.builder().store(store2).keyword(keyword6).build()
//            em.persist(storeKeyword6)
//            val storeKeyword7 = StoreKeyword.builder().store(store3).keyword(keyword4).build()
//            em.persist(storeKeyword7)
//            val storeKeyword8 = StoreKeyword.builder().store(store3).keyword(keyword5).build()
//            em.persist(storeKeyword8)
//            val storeKeyword9 = StoreKeyword.builder().store(store3).keyword(keyword7).build()
//            em.persist(storeKeyword9)
//            val storeKeyword10 = StoreKeyword.builder().store(store4).keyword(keyword8).build()
//            em.persist(storeKeyword10)
//            val storeKeyword11 = StoreKeyword.builder().store(store4).keyword(keyword9).build()
//            em.persist(storeKeyword11)
//            val storeKeyword12 = StoreKeyword.builder().store(store4).keyword(keyword10).build()
//            em.persist(storeKeyword12)
//            val storeKeyword13 = StoreKeyword.builder().store(store5).keyword(keyword5).build()
//            em.persist(storeKeyword13)
//            val storeKeyword14 = StoreKeyword.builder().store(store5).keyword(keyword11).build()
//            em.persist(storeKeyword14)
//            val storeKeyword15 = StoreKeyword.builder().store(store5).keyword(keyword12).build()
